#!/usr/bin/env python3
"""Build the Value-of-Information calibration bank from the independent ImageReward corpus.

The Value-of-Information protocol only needs, per trajectory, ImageReward at step 16, at
...
`calibration/bank.parquet` required by the Value-of-Information protocol, and validates
